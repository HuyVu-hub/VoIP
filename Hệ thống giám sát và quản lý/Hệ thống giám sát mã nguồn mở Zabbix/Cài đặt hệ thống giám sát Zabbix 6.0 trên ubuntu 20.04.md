...
**Bạn nên kiểm tra file tải về trên zabbix: https://repo.zabbix.com/zabbix/ Vì các gói liên tục được cập nhât, và lựa chọn đúng với phiên bản ubuntu20.04 của mình ..... Và một lưu ý nữa, bạn nên cài bản 5.0 để không bị gặp lỗi này nhé **
